...
}); + totalLossFromTop5.toFixed(2), '', '', '', ''],
            ['Average Loss per Item (Top 5)', '
...
}); + (totalLossFromTop5 / results.lossGenerators.length).toFixed(2), '', '', '', ''],
...
}); + (totalLossFromTop5 * 12).toFixed(2), 'if trends continue', '', '', ''],
...
}); + (totalLossFromTop5 * 0.8 * 12).toFixed(2), 'annually', '', '', ''],
            [],
            ['=== ACTION PRIORITIES ===', '', '', '', '', ''],
